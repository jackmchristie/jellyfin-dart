# jellyfin_dart.model.MediaStream
...
**hdr10PlusPresentFlag** | **bool** |  | [optional] 
**videoRange** | [**VideoRange**](VideoRange.md) | Gets the video range. | [optional] [default to 'Unknown']
**videoRangeType** | [**VideoRangeType**](VideoRangeType.md) | Gets the video range type. | [optional] [default to 'Unknown']
**videoDoViTitle** | **String** | Gets the video dovi title. | [optional] 
**audioSpatialFormat** | [**AudioSpatialFormat**](AudioSpatialFormat.md) | Gets the audio spatial format. | [optional] [default to 'None']
